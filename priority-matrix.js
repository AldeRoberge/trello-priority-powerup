  ...
  var DEFAULT_RULES = [
    {
      ...
      description: 'Impact majeur, facile à lancer, deadline serrée. Le moment idéal pour agir.',
      priority: 100,
    ...
    },
    {
      ...
      description: 'Presque sans effort, impact modeste mais net positif. À saisir quand il reste dix minutes.',
      priority: 89,
    ...
    },
    {
      id: 'coup-de-pouce',
      label: 'Coup de pouce',
      description: 'Impact moyen, deadline serrée, exécution facile. Débloque la suite sans y passer la journée.',
      priority: 87,
    ...
    },
    {
      ...
      label: 'En veille',
      description: 'Effort élevé pour une valeur limitée, sans deadline. Patienter jusqu\'à ce qu\'un levier change.',
      priority: 83,
    ...
    },
    {
      ...
      description: 'Pas le bon timing : retour modeste, zéro échéance, coût élevé. Garder visible sans lancer tout de suite.',
      priority: 83,
    ...
    },
    {
      id: 'fondation',
      label: 'Fondation',
      description: 'Travail structurant, effort soutenu, impact réel avec calendrier souple. Pose les bases des prochains gains.',
      priority: 84,
    ...
    },
    {
      ...
      description: 'Enjeu moyen, effort soutenu, deadline proche. Protéger le scope et livrer l\'essentiel avec sérénité.',
      priority: 83,
    ...
    },
    {
      id: 'marathon',
      label: 'Marathon',
      description: 'Long et exigeant, valeur moyenne, pas de deadline proche. À étaler sereinement, pas à forcer d\'un bloc.',
      priority: 74,
